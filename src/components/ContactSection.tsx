...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_ztlawm4', // You'll need to replace this with your service ID
        'template_cr644i9', // You'll need to replace this with your template ID
        templateParams,
        'ZFyNCpyidElJX0HfS' // You'll need to replace this with your public key
      );
